...
use devtools_traits::{
    ChromeToDevtoolsControlMsg, ConsoleLogLevel, ConsoleMessage, ConsoleMessageFields, DevtoolScriptControlMsg, DevtoolsControlMsg, DevtoolsPageInfo, DomMutation, EnvironmentInfo, FrameInfo, FrameOffset, NavigationState, NetworkEvent, PauseReason, ScriptToDevtoolsControlMsg, SourceInfo, WorkerId, get_time_stamp
};
    ...
    fn run(mut self) {
        ...
        while let Ok(msg) = self.receiver.recv() {
            ...
            match msg {
                ...
                DevtoolsControlMsg::FromScript(ScriptToDevtoolsControlMsg::CreateEnvironmentActor(
                    result_sender,
                    environment,
                    parent,
