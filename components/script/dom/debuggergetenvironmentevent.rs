...
use crate::dom::bindings::codegen::Bindings::DebuggerFrameEventBinding::DebuggerGetEnvironmentEventMethods;
...
impl DebuggerGetEnvironmentEvent {
    pub(crate) fn new(
        ...
        result.event.init_event("getEnvironment".into(), false, false);
