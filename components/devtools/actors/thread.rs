...
impl ResumeRequest {
    fn get_type(&self) -> Option<String> {
        ...
        // TODO: Change this so that it doesn't include the quotes
...
impl Actor for ThreadActor {
    ...
    fn handle_message(
        ...
        match msg_type {
            ...
            "frames" => {
                // TODO: This should probably need to call debugger.js and get the youngest
                // frame and its parents, instead of self.frames
                // Also, frame actors should be registered here
