...
impl DebuggerGlobalScope {
    ...
    pub(crate) fn fire_pause(&self, can_gc: CanGc, result_sender: GenericSender<devtools_traits::PauseFrameResult>) {
        assert!(self.get_frame_result_sender.replace(Some(result_sender)).is_none());
